...
import { EffectExecutionParams, FiniteDuration } from './core'

export type DistortionBandEffectConfig =
  EffectConfig<FiniteDuration> & {
    direction: Direction
...
export type DistortionBandEffectExecutionParams =
